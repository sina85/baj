...
bool LoadAPI() {
	NtQuerySystemInformation = (PNtQuerySystemInformation)MyGetProcAddress(GetModuleHandleA("ntdll.dll"), (LPSTR)"NtQuerySystemInformation");

	NtQueryObject = (PNtQueryObject)MyGetProcAddress(GetModuleHandleA("ntdll.dll"), (LPSTR)"NtQueryObject");

	NtQueryInformationThread = (PNtQueryInformationThread)MyGetProcAddress(GetModuleHandleA("ntdll.dll"), (LPSTR)"NtQueryInformationThread");

	NtQueryInformationFile = (PNtQueryInformationFile)MyGetProcAddress(GetModuleHandleA("ntdll.dll"), (LPSTR)"NtQueryInformationFile");

	NtQueryInformationProcess = (PNtQueryInformationProcess)MyGetProcAddress(GetModuleHandleA("ntdll.dll"), (LPSTR)"NtQueryInformationProcess");
...
void list_files(pFileLinkedList& file_head, pFileLinkedList& file_tail) {
	...
	ret = GetLogicalDriveStringsA(MAXD, buff);
